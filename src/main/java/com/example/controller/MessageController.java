...
public class MessageController {
    ...
    public String like(
            ...
            RedirectAttributes redirectAttributes,//параметры что мы получили при запросе на referrer
        ...
        UriComponents components = UriComponentsBuilder.fromHttpUrl(referer).build();//извлекаем параметры из referrer
